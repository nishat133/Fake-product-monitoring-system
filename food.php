<?php
	...
	$sql = "SELECT * FROM products where category=6 ORDER BY pid "; 
...
<?php
	...
	while($row = mysqli_fetch_assoc($result))
	{
		...
		echo"<td><div class = 'box'><img src = 'images/food/{$row['image']}' alt = '{$row['pid']}'>
		<h4><b>{$row['pname']}<b></h4>
		<h3>Price: <b>Rs.{$row['price']}</b></h3>
		<br>
		<form action = 'food_shop.php?pid=$pid & login=$login & username=$username' method = 'post'>
